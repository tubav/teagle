...
public class PermanentErrorException
    extends Exception
{
     ...
     * @param faultInfo
     */
    public PermanentErrorException(String message, ServiceExceptionType faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public PermanentErrorException(String message, ServiceExceptionType faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
