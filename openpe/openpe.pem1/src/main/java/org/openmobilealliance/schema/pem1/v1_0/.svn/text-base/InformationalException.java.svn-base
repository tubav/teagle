...
public class InformationalException
    extends Exception
{
     ...
     * @param faultInfo
     */
    public InformationalException(String message, ServiceExceptionType faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public InformationalException(String message, ServiceExceptionType faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
