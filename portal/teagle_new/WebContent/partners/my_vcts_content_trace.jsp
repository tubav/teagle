...
<%
			//faking for Alex' video:
			if(user.equals("testuser")){
%>
			<tr>
				<td colspan="2" bgcolor="#dddddd"><strong>pnodes</strong></td>
				<td colspan="2" bgcolor="#70ff70" align="center">booked</td>
			</tr>
			<tr>
				<td></td>
				<td bgcolor="#efefef">//xfokus/pnode_0</td>
				<td bgcolor="#beffbe" align="center">provisioned</td>
				<td><a href="traces_test.jsp?resourceId=//xfokus/pnode_0"> Traces </a></td>
			</tr>
			<tr>
				<td style="height:10px"></td>
			</tr>
			<tr>
				<td colspan="2" bgcolor="#dddddd"><strong>xennodes</strong></td>
				<td colspan="2" bgcolor="#70ff70" align="center">booked</td>
			</tr>
			<tr>
				<td></td>
				<td bgcolor="#efefef">//xfokus/pnode_0/xennode_196</td>
				<td bgcolor="#beffbe" align="center">provisioned</td>
				<td><a href="traces_test.jsp?resourceId=//xfokus/pnode_0/xennode_196"> Traces </a></td>
			</tr>
			<tr>
				<td></td>
				<td bgcolor="#efefef">//xfokus/pnode_0/xennode_197</td>
				<td bgcolor="#beffbe" align="center">provisioned</td>
				<td><a href="traces_test.jsp?resourceId=//xfokus/pnode_0/xennode_197"> Traces </a></td>
			</tr>
			<tr>
				<td style="height:10px"></td>
			</tr>
...
%>
				...
				<td><a href="traces_test.jsp?resourceId=<%=encodedResId%>"> Traces </a></td>
			</tr>
<%  			
						}
					}
