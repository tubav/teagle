                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:emailInstance, field:'address')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="person" action="show" id="${emailInstance?.person?.id}">${emailInstance?.person?.encodeAsHTML()}</g:link></td>
